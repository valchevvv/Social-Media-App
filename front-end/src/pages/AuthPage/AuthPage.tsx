  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div
          className="sm:absolute inset-0 bg-gradient-to-r from-cyan-400 to-sky-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
        </div>
        <div className="relative px-4 sm:py-10 sm:bg-white sm:shadow-lg sm:rounded-3xl sm:p-20">
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleSubmit} className="px-10 sm:px-0 py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="flex justify-center pt-2">
                  <button type='submit' className="bg-cyan-500 text-white rounded-md text-base px-5 py-2 sm:px-2 sm:py-1">{isLogin ? "Login" : "Register"}</button>
                </div>
