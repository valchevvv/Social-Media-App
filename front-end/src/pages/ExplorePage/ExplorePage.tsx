      ...
      <div className="grid grid-cols-2 gap-4 mobile:grid-cols-3 laptop:grid-cols-3 desktop:grid-cols-4">
        {posts.map(post => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-50 text-white p-4 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end z-10 mobile:hidden">
