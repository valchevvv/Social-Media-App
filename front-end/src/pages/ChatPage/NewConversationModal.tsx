  ...
  return (
    <div className="flex flex-col gap-3 max-h-96 overflow-y-auto">
      ...
      {filteredContacts.map(contact => (
        <div
          key={contact._id}
          className="flex flex-row justify-between items-center bg-gray-50 shadow p-2 rounded-lg"
        >
          <div className="flex flex-row gap-3 items-center">
            <img
              src={contact.profilePicture || profile_picture}
              alt=""
