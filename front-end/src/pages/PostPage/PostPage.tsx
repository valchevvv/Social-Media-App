...
const PostPage = () => {
    ...
    const handleUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                imagePreview.current?.setAttribute('src', reader.result as string)
            }
    ...
    return (
        <div className="flex flex-col py-10 items-center gap-5">
            <div className="flex flex-col items-center">
                <div className="mb-4">
                    <img id="imagePreview" ref={imagePreview} onClick={() => { imageUpload && imageUpload.current?.click(); }} className="w-64 h-64 object-cover rounded-lg cursor-pointer" src="https://via.placeholder.com/150" alt="Image Preview" />
                </div>
                <input type="file" ref={imageUpload} onChange={(e) => { handleUpload(e) }} id="imageUpload" className="hidden" accept="image/*" />
            </div>
            <div className="w-[70%]">
