...
const Navigation = () => {
    return (
        <div className="bg-gray-800 shadow laptop:hidden fixed bottom-2 left-[50%] p-2 translate-x-[-50%] w-[80%] h-[60px] text-white flex flex-row justify-center rounded-2xl backdrop-blur bg-opacity-60">
